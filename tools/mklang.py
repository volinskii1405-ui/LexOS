...
'dkx_l_create': ('Создать', 'Crear'),
'dkx_l_newdir': ('Папку', 'Una carpeta'),
'dkx_l_newtxt': ('Текстовый файл (TXT)', 'Un texto (TXT)'),
'dkx_l_newhg': ('Скрипт (HG)', 'Un script (HG)'),
'dkx_l_newlnk': ('Ярлык', 'Un acceso directo'),
'dkx_l_iopen': ('Открыть', 'Abrir'),
'dkx_l_irename': ('Переименовать...', 'Renombrar...'),
'dkx_l_idelete': ('Удалить', 'Eliminar'),
'dkn_t_rename': ('Переименовать', 'Renombrar'),
'dkn_t_newdir': ('Новая папка', 'Carpeta nueva'),
'dkn_t_newtxt': ('Новый текстовый файл', 'Texto nuevo'),
'dkn_t_newhg': ('Новый скрипт', 'Script nuevo'),
'dkn_t_newlnk': ('Новый ярлык', 'Acceso directo nuevo'),
'dkn_t_copyto': ('Копировать в', 'Copiar a'),
'dkn_p_name': ('Имя (до 15 символов):', 'Nombre (hasta 15 caracteres):'),
'dkn_p_target': ('Что он открывает (путь, например /APPS/FIRE.APP):', 'Qué abre (una ruta, p. ej. /APPS/FIRE.APP):'),
'dkn_p_folder': ('Папка, куда копировать (например /DEMOS или /):', 'La carpeta de destino (p. ej. /DEMOS, o /):'),
'dkn_l_ok': ('ОК', 'Aceptar'),
'dkn_l_cancel': ('Отмена', 'Cancelar'),
'dkn_m_empty': ('Сначала введите имя.', 'Escribe un nombre primero.'),
'dkn_m_taken': ('Такое имя здесь уже есть.', 'Ese nombre ya existe aquí.'),
'dkn_m_full': ('На диске нет места.', 'No queda espacio en el disco.'),
'dkn_m_protected': ('USER.CFG трогать нельзя.', 'USER.CFG no se puede cambiar.'),
'dkn_m_read_only': ('Только для чтения (attrib -r).', 'Es de solo lectura (attrib -r).'),
'dkn_m_nothing': ('По этому пути ничего нет.', 'No hay nada en esa ruta.'),
'dkn_m_not_folder': ('Это не папка.', 'No es una carpeta.'),
'dkn_m_files_only': ('Копировать можно только файлы.', 'Solo se pueden copiar archivos.'),
'dkn_m_long': ('Не больше 15 символов.', 'Como mucho 15 caracteres.'),
'dkn_m_invalid': ('В имени нельзя: / \\ | < > * ? : и пробел.', 'No valen en un nombre: / \\ | < > * ? : ni espacios.'),
...
'dkp_l_kind': ('Тип:', 'Tipo:'),
'dkp_l_size': ('Размер:', 'Tamaño:'),
'dkp_l_time': ('Изменён:', 'Modificado:'),
'dkp_l_ro': ('Только чтение', 'Solo lectura'),
'dkp_m_ro_hint': ('(нельзя изменить, переименовать, удалить)', '(no se puede cambiar, renombrar ni borrar)'),
'dkp_m_reading': ('Читаю...', 'Leyendo...'),
'dkp_m_bytes': (' байт', ' bytes'),
'dkp_m_kb': (' КБ)', ' KB)'),
'dkp_m_items': (' шт.', ' elementos'),
'dkp_k_folder': ('Папка', 'Carpeta'),
'dkp_k_program': ('Программа', 'Programa'),
'dkp_k_text': ('Текстовый файл', 'Archivo de texto'),
'dkp_k_file': ('Файл', 'Archivo'),
'dkp_k_script': ('Скрипт (HG)', 'Script (HG)'),
'dkp_k_basic': ('Программа на BASIC', 'Programa BASIC'),
'dkp_k_c': ('Исходник на C', 'Código C'),
'dkp_k_asm': ('Исходник на ассемблере', 'Código ensamblador'),
...
'dkp_k_html': ('Веб-страница', 'Página web'),
'dkp_k_md': ('Текст Markdown', 'Texto Markdown'),
'dkp_k_zip': ('Архив ZIP', 'Archivo ZIP'),
'dkp_k_data': ('Данные', 'Datos'),
