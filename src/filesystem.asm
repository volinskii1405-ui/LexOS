...
; другого не меняя.
;
; Экспортирует: fs_save, fs_cat, fs_rm, fs_list, fs_ren, fs_size, fs_clear,
;               fs_edit, fs_mkdir, fs_cd, fs_ensure_readme, fs_print_prompt
...
; --- save <имя> <текст> : DS:SI указывает на "<имя> <текст>" ---
fs_save:
    push ax
    push bx
    push cx
...
; --- edit <имя> <новое содержимое> (требует, чтобы файл уже существовал) ---
fs_edit:
    push ax
    push bx
    push cx
