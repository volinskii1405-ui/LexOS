...
; from the host side. Capped at CONTENT_BUF_LEN (4096) bytes, same as
; any other file's visible/editable content (fs_load_content,
; src/fs_extra.asm) - content past that just isn't reachable this way.
; ============================================================
cmd_recv:
    push ax
    push bx
